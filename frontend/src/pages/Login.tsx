...
const styles: Record<string, React.CSSProperties> = {
  ...
  title:    { textAlign: 'center', color: '#1a56db', fontSize: '2rem', margin: '0 0 4px' },
  subtitle: { textAlign: 'center', color: '#6b7280', marginBottom: '1.5rem' },
  form:     { display: 'flex', flexDirection: 'column', gap: '0.75rem' },
  label:    { fontWeight: '500', color: '#374151', fontSize: '0.9rem' },
  input:    { padding: '0.65rem 1rem', border: '1px solid #d1d5db', borderRadius: '8px', fontSize: '1rem', outline: 'none' },
  ...
  error:    { background: '#fee2e2', color: '#b91c1c', padding: '0.65rem 1rem', borderRadius: '8px', marginBottom: '1rem', fontSize: '0.9rem' },
